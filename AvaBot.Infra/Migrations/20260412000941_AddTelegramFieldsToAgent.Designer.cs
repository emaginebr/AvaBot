...
namespace AvaBot.Infra.Migrations
{
    ...
    [Migration("20260412000941_AddTelegramFieldsToAgent")]
    partial class AddTelegramFieldsToAgent
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AvaBot.Domain.Models.Agent", b =>
                {
                    ...
                    b.Property<string>("TelegramWebhookSecret")
                        .HasMaxLength(260)
                        .HasColumnType("character varying(260)")
                        .HasColumnName("telegram_webhook_secret");
            ...
            modelBuilder.Entity("AvaBot.Domain.Models.ChatSession", b =>
                {
                    ...
                    b.HasIndex("ResumeToken")
                        .IsUnique()
                        .HasDatabaseName("ix_avabot_chat_sessions_resume_token");
            ...
            modelBuilder.Entity("AvaBot.Domain.Models.TelegramChat", b =>
                {
                    ...
                    b.HasKey("TelegramChatId")
                        .HasName("avabot_telegram_chats_pkey");
